...
// ── Experience Data (hardcoded from server/data/experience.json) ──
// Single source of truth now lives here instead of the backend.
export const experienceData = [
  {
    ...
    time: '2025 — 2029',
    period: '2025 – Present',
    periodLabel: 'Academic & Core Roles',
    description: 'Core coursework in Algorithms, Data Structures, Computer Architecture, and Object-Oriented Programming.',
    detail: 'Core coursework in Algorithms, Data Structures, Computer Architecture, and Object-Oriented Programming.',
    skills: ['Algorithms', 'Data Structures', 'Computer Architecture', 'Object-Oriented Programming'],
    links: {},
    color: '#0072E3',
    order: 1,
  },
  {
    id: 'coding-club-design-associate',
    ...
    period: '2025 – Present',
    periodLabel: 'Academic & Core Roles',
    description: 'Conceptualized branding identities, event posters, official ID cards, club apparel, and digital promotional campaigns.',
    detail: 'Conceptualized branding identities, event posters, official ID cards, club apparel, and digital promotional campaigns.',
    skills: ['Branding', 'UI/UX', 'Visual Systems', 'Event Marketing'],
    links: {},
    color: '#FFB200',
    order: 2,
  },
  {
    id: 'rotaract-editorial-director',
    ...
    period: '2025 – Present',
    periodLabel: 'Academic & Core Roles',
    description: 'Directing creative content presentation, editorial communication, newsletters, and visual storytelling for community outreach.',
    ...
    skills: ['Editorial Direction', 'Content Presentation', 'Newsletters', 'Storytelling'],
    links: {},
    color: '#EF333A',
    order: 3,
  },
  {
    id: 'decode2deploy-hackathon',
    ...
    periodLabel: 'Competitive Sprints',
    description: 'Intensive building sprint tackling real-world problem statements under 24-hour pressure.',
    detail: 'Intensive building sprint tackling real-world problem statements under 24-hour pressure.',
    skills: ['Rapid Prototyping', 'Problem Solving', 'Full Stack Development'],
    links: {},
    color: '#00AA3C',
    order: 4,
  },
  {
    id: 'rnsit-impactx-challenge',
    ...
    period: '2026 Hackathons',
    periodLabel: 'Competitive Sprints',
    description: 'Collaborative prototyping, multi-disciplinary engineering, and rapid pitch evaluation.',
    detail: 'Collaborative prototyping, multi-disciplinary engineering, and rapid pitch evaluation.',
    skills: ['Collaborative Prototyping', 'Engineering Systems', 'Pitch Evaluation'],
    links: {},
    color: '#AB54F7',
    order: 5,
  },
  {
    ...
    period: '2026 Hackathons',
    periodLabel: 'Competitive Sprints',
    description: 'Hardware & IoT integration with cloud telemetry and live prototype demonstration.',
    detail: 'Hardware & IoT integration with cloud telemetry and live prototype demonstration.',
    skills: ['Hardware & IoT', 'Cloud Telemetry', 'ESP32', 'Prototype Demonstration'],
    links: {},
    color: '#FF6100',
    order: 6,
  },
...
// ── Skills Data (hardcoded from server/data/skills.json + canonical tech list) ──
// Derived from the manual overrides + additional entries in skills.json.
export const skillsData = [
  { id: 'javascript', name: 'JavaScript', category: 'Languages', source: 'github', count: 4, projects: ['SparkHabit', 'Amazon-Clone', 'Netflix-Clone', 'Portfolio'], order: 1 },
  { id: 'typescript', name: 'TypeScript', category: 'Languages', source: 'github', count: 2, projects: ['Cleanzy', 'Portfolio'], order: 2 },
  { id: 'html', name: 'HTML', category: 'Frontend', source: 'github', count: 3, projects: ['Netflix-Clone', 'Portfolio', 'SparkHabit'], order: 3 },
  { id: 'css', name: 'CSS', category: 'Frontend', source: 'github', count: 3, projects: ['Netflix-Clone', 'Portfolio', 'SparkHabit'], order: 4 },
  { id: 'react', name: 'React', category: 'Frontend', source: 'manual', count: 3, projects: ['Portfolio', 'Cleanzy', 'EchoNex'], order: 5 },
  { id: 'c-plus-plus', name: 'C++', category: 'Languages', source: 'manual', count: 1, projects: ['EchoNex'], order: 6 },
  { id: 'python', name: 'Python', category: 'Languages', source: 'manual', count: 1, projects: ['AI Projects'], order: 7 },
  { id: 'esp32', name: 'ESP32', category: 'Hardware / IoT', source: 'manual', count: 1, projects: ['EchoNex'], order: 8 },
  { id: 'supabase', name: 'Supabase', category: 'Database', source: 'manual', count: 1, projects: ['EchoNex'], order: 9 },
  { id: 'figma', name: 'Figma', category: 'Tools', source: 'manual', count: 0, projects: [], order: 10 },
  { id: 'git', name: 'Git', category: 'Tools', source: 'manual', count: 0, projects: [], order: 11 },
  { id: 'vite', name: 'Vite', category: 'Frontend', source: 'manual', count: 1, projects: ['Portfolio'], order: 12 },
];
